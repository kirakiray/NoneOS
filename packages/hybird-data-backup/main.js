...
export class HybirdData extends Stanz {
  ...
  async _initData(data, options) {
    ...
    const markData = this.getMarkData();
    const markValues = Object.values(markData);
    const backupSelf = { ...this };

    // TODO: 删除不需要的数据
    // TODO: 已存在的对象数据不需要再更新
    // TODO: 对数组内的数据，保证排序的对象进行修正
