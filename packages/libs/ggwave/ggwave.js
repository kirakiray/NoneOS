var ggwave_factory = (() => {
  ...
  return function (moduleArg = {}) {
    ...
    var printChar = (stream, curr) => {
      ...
      if (curr === 0 || curr === 10) {
        const message = UTF8ArrayToString(buffer, 0);
        if (moduleArg.__printCall) {
          moduleArg.__printCall(message);
        } else {
          (stream === 1 ? out : err)(message);
        }
        buffer.length = 0;
      } else {
        buffer.push(curr);
    ...
    var ___cxa_is_pointer_type = (a0) =>
      (___cxa_is_pointer_type = wasmExports["H"])(a0);
